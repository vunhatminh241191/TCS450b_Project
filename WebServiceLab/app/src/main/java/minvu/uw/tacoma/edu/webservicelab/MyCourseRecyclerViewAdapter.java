...
import minvu.uw.tacoma.edu.webservicelab.CourseFragment.OnListFragmentInteractionListener;
...
public class MyCourseRecyclerViewAdapter extends RecyclerView.Adapter<MyCourseRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).mcourseID);
        holder.mContentView.setText(mValues.get(position).mshortDescription);
